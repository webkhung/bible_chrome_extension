...
//  var divYears = $("<div>").addClass("calYear");
  ...
  // Kelvin Added
  calendar.addHtml = function(date, html){
      $('#' + (date)).html(html);
  }
...
//          span.html("<span class=dayNumber id='" + formatDate(d) + "''>" + d.getDate() + "</span><br>" + options.dayNames[d.getDay()]).css("width",w);
          span.html("<span class=dayNumber>" + d.getDate() + "</span><br><span id='" + formatDate(d) + "''></span>").css("width",w);
